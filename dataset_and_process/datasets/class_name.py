...
mini_train = [
    "house finch", "robin", "triceratops", "green mamba", "harvestman", "toucan", "jellyfish", "dugong", "Walker hound", "Saluki",
    "Gordon setter", "komondor", "boxer", "Tibetan mastiff", "French bulldog", "Newfoundland", "miniature poodle", "Arctic fox", "ladybug", "three-toed",
    "rock beauty", "aircraft carrier", "trash can", "barrel", "beer bottle", "carousel", "chime", "clog", "cocktail shaker", "dishrag",
    "dome", "filing cabinet", "fire screen", "frying pan", "hair slide", "holster", "lipstick", "oboe", "organ", "parallel bars",
    "pencil box", "photocopier", "prayer rug", "reel", "slot machine", "snorkel", "solar dish", "spider web", "stage", "tank",
    "tile roof", "tobacco shop", "unicycle", "upright", "wok", "worm fence", "yawl", "street sign", "consomme", "hotdog",
    "orange", "cliff", "bolete", "corn cob"
]

mini_val = [
    "goose", "Ibizan hound", "Alaskan tundra wolf", "meerkat", "rhinoceros beetle", "cannon", "cardboard box / carton", "catamaran",
    "combination lock", "garbage truck", "horizontal bar", "iPod", "miniskirt", "missile", "poncho", "coral reef"
]

mini_test = [
    "nematode", "king crab", "golden retriever", "malamute", "dalmatian", "African hunting dog", "lion", "ant", "black-footed ferret", "bookshop",
    "crate", "cuirass", "electric guitar", "hourglass", "mixing bowl", "school bus", "scoreboard", "theater curtain", "vase", "trifle"
]

clippart = ['aircraft_carrier', 'airplane', 'alarm_clock', 'ambulance', 'angel', 'animal_migration', 'ant', 'anvil', 'apple', 'arm', 'asparagus',
...
flowers102 = ['pink primrose', 'hard-leaved pocket orchid', 'canterbury bells', 'sweet pea', 'english marigold', 'tiger lily', 'moon orchid', 'bird of paradise', 'monkshood', 'globe thistle', 'snapdragon', "colt's foot", 'king protea', 'spear thistle', 'yellow iris', 'globe-flower', 'purple coneflower', 'peruvian lily', 'balloon flower', 'giant white arum lily', 'fire lily', 'pincushion flower', 'fritillary', 'red ginger', 'grape hyacinth', 'corn poppy', 'prince of wales feathers', 'stemless gentian', 'artichoke', 'sweet william', 'carnation', 'garden phlox', 'love in the mist', 'mexican aster', 'alpine sea holly', 'ruby-lipped cattleya', 'cape flower', 'great masterwort', 'siam tulip', 'lenten rose', 'barbeton daisy', 'daffodil', 'sword lily', 'poinsettia', 'bolero deep blue', 'wallflower', 'marigold', 'buttercup', 'oxeye daisy', 'common dandelion', 'petunia', 'wild pansy', 'primula', 'sunflower', 'pelargonium', 'bishop of llandaff', 'gaura', 'geranium', 'orange dahlia', 'pink-yellow dahlia', 'cautleya spicata', 'japanese anemone', 'black-eyed susan', 'silverbush', 'californian poppy', 'osteospermum', 'spring crocus', 'bearded iris', 'windflower', 'tree poppy', 'gazania', 'azalea', 'water lily', 'rose', 'thorn apple', 'morning glory', 'passion flower', 'lotus', 'toad lily', 'anthurium', 'frangipani', 'clematis', 'hibiscus', 'columbine', 'desert-rose', 'tree mallow', 'magnolia', 'cyclamen', 'watercress', 'canna lily', 'hippeastrum', 'bee balm', 'ball moss', 'foxglove', 'bougainvillea', 'camellia', 'mallow', 'mexican petunia', 'bromelia', 'blanket flower', 'trumpet creeper', 'blackberry lily']

eurosat = ['Annual Crop Land', 'Forest', 'Herbaceous Vegetation Land', 'Highway or Road', 'Industrial Buildings', 'Pasture Land', 'Permanent Crop Land', 'Residential Buildings', 'River', 'Sea or Lake']
