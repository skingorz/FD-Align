...
class quickDraw(general_dataset):
    def __init__(self, root="data/meta-dataset/quickdraw", mode="test", backbone_name="resnet12", transform=None):
...
if __name__ == "__main__":
    ...
    test = quickDraw("data/meta-dataset/quickdraw", "test")
