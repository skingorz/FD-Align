...
class infoGraph(general_dataset):
    def __init__(self, root="data/meta-dataset/infograph", mode="test", backbone_name="resnet12", transform=None):
...
if __name__ == "__main__":
    ...
    test = infoGraph("data/meta-dataset/infograph", "test")
